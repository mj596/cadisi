...
! Version of 6 June 2013 (version of cadisi with integration instead maximum)
...
REAL :: phadc,dtfine,tamp,wfac,tfines
...
REAL :: sigma02,sigma12,telaps1,telaps2,pulsid,pulsis
...
END DO
inte0 = inte0-1
! Index range for pulse integration, as in sim_telarray, 30 x 4 ns interval
! 1 ns before tamp -- 119 ns after tamp
inte1 = inte0 - 10
inte2 = inte0 + 1190
WRITE(*,*) 'Pulse integral limits:', inte0,inte1,tt(inte1),inte2,tt(inte2)
...
pulsid = 0.0
DO i = inte1, inte2
    pulsid = pulsid + fadeco(i)
END DO

pulsid = (pulsid-REAL(inte2-inte1)*bgsumde)*dt

WRITE(10,*) 'Pulse integral (deconvolved):', pulsid
IF (ipr == 1) WRITE(*,*) 'Pulse integral (deconvolved):', pulsid
...
pulsis = 0.0
DO i = inte1, inte2
    pulsis = pulsis + fasa(i)
END DO

pulsis = (pulsis-REAL(inte2-inte1)*bgsumsh)*dt

WRITE(10,*) 'Pulse integral (shaped):', pulsis
IF (ipr == 1) WRITE(*,*) 'Pulse integral (shaped):', pulsis
