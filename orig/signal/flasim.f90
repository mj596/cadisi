...
REAL :: dif1,dif2,dif3,dif4,fasumi,defa,signorm,onepa,wnomeanpe

INTEGER, DIMENSION(200000) :: nf,nno
...
!WRITE(*,*) 'White noise amplitude, absolute and in p.e. units:', wnomean, wnomeanpe
...
WRITE(19,*) 'Derivative integral:', amsum,fasum
...
!    nbgde = nbgde + 1
!  END IF
  IF (tt(i) > 1250.0 .AND. tt (i) < 1950.0) THEN
    bgsumde = bgsumde + fadeco(i)
    nbgde = nbgde + 1
  END IF
END DO
